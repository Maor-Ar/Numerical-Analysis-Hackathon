...
def func(val):
    ...
    """
    x = sp.symbols('x')
    my_f = (2 * x * sp.exp(-x) + sp.ln(2 * x ** 2)) * (2 * x ** 4 + 2 * x ** 2 - 3 * x - 5)
...
def MainFunction():
    ...
    checkRange = frange(0, 1.5, 0.1)
    epsilon = 0.00001
    print("\nFinding roots of the equation f(X) = ( 2Xe^-X + ln(2X^2) ) * (2X^4 + 2X^2 - 3X - 5 )\n")
    print("Bisection Method on ( 2Xe^-X + ln(2X^2) ) * (2X^4 + 2X^2 - 3X - 5 ) :\n" )
    ...
    roots.clear()
    print("\nSecant Method on ( 2Xe^-X + ln(2X^2) ) * (2X^4 + 2X^2 - 3X - 5 ) :\n")
    ...
    print("\nFinding area of the equation f(X) = ( 2Xe^-X + ln(2X^2) ) * (2X^4 + 2X^2 - 3X - 5 )\n")
    print("Simpson Rule on ( 2Xe^-X + ln(2X^2) ) * (2X^4 + 2X^2 - 3X - 5 ) :")
    ...
    n =20
    print("Rumberg Rule on ( 2Xe^-X + ln(2X^2) ) * (2X^4 + 2X^2 - 3X - 5 ) :\n")
